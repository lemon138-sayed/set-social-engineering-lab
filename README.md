# set-social-engineering-lab
Authorized social-engineering security lab using Kali Linux, SET, Metasploit, and Meterpreter to analyze phishing attack paths and defensive security controls.
...
Authority - appears to come from support
Urgency - implies immediate action is necessary
Fear of consequence - suggests certificates or access may expire
Convenience - provides a direct link
